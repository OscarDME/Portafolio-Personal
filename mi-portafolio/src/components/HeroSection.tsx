  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center w-full h-full gap-8 md:gap-16 text-center md:text-left px-4 md:px-16">
        <div className="w-80 h-80 relative rounded-full overflow-hidden shadow-xl bg-white">
          <Image
            src="/yo.png"
            alt="Yo"
            fill
        ...
        <div className="max-w-xl">
          ...
          <Link href="/projects">
            <Button size="xl" className="bg-blue-600 hover:bg-blue-700 text-white text-md">
              {t('cta')}
            </Button>
          </Link>
        </div>
